    ...
    let pr = new Promise((resolve, reject) => {
        ...
        fs.readFile(p, (err, fileContent) => {
            if (!err) {
                ...
                products = products.map(product => product.hasOwnProperty('price') ? product : defaultProduct);
            }
            resolve(products)
        })
    })
